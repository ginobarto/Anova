...
Se compararán los grupos de deportistas estudiados.
...
Se ajusta el modelo para los datos tal como se planteó anteriormente ($y_{ij} = \mu + \tau_i + e_{ij}, \ i=\overline{1,a} \ \land \ j=\overline{1,n_i}$).
